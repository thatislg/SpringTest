	...
	<dl>
		...
		<dd>
			<form:select path="section3Id">
				...
				<form:option items="${section3List}" itemValue="id" itemLabel="name" />
			</form:select>
		</dd>
		<dt>インフラ有無</dt>
		<dd>
			<form:checkboxes items="${infrastructureList}" itemValue="id" itemLabel="name"
			path="infrastructureIdList"/>
		</dd>
	</dl>
